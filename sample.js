  ...
  for (let i = 0; i < 20; i++) {
    ...
    if (hit || i == 0) {
      ...
      for (let k = 0; k < 2; k++) {
        ...
        if (hit) {
          rows += '"' + Object.values(clone2).join('","') + '"\n'
        }
      }

      rows = '"' + Object.values(clone).join('","') + '"\n' + rows
    }
  }
